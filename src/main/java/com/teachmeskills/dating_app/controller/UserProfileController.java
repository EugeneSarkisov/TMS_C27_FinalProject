...
public class UserProfileController {
    ...
    public String addUserHobby(@RequestParam("hobbie") String hobby) throws Exception {
    ...
    public String removeUserHobby(@RequestParam("hobbieDelete") String hobby) throws Exception {
        int userId = userAccountRepository.findUserAccountByUsername(userProfileService.getAuthUser()).getId();
        int hobbyId = hobbiesRepository.getHobbyIdByName(hobby);
    ...
    public String changeUserPhoto(@RequestParam("gender") String gender, @RequestParam("relation") String relationName) throws IOException {
